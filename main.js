...
`, "",{"version":3,"sources":["webpack://./src/css/styles.css"],"names":[],"mappings":"AAAA;EACE,UAAU;EACV,SAAS;EACT,sBAAsB;AACxB;AACA;EACE,gCAAgC;EAChC,kCAAkC;AACpC;AACA;;EAEE,gBAAgB;EAChB,iBAAiB;EACjB,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,aAAa;EACb,6EAA6E;EAC7E,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,OAAO;EACP,SAAS;AACX;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,cAAc;EACd,gBAAgB;EAChB,WAAW;EACX,kBAAkB;EAClB,QAAQ;AACV;;AAEA;EACE,qBAAqB;EACrB,OAAO;EACP,kBAAkB;EAClB,aAAa;EACb,QAAQ;AACV;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,OAAO;EACP,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,qBAAqB;EACrB,YAAY;AACd;;AAEA;EACE,6BAA6B;EAC7B,yBAAyB;AAC3B;;AAEA;EACE,+BAA+B;EAC/B,yBAAyB;AAC3B;;AAEA;EACE,OAAO;EACP,qBAAqB;EACrB,kBAAkB;EAClB,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,OAAO;EACP,aAAa;AACf;;AAEA;;EAEE,OAAO;EACP,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,6BAA6B;EAC7B,yBAAyB;EACzB,YAAY;AACd;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;;EAEE,+BAA+B;AACjC;;AAEA;EACE,OAAO;EACP,aAAa;AACf;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,QAAQ;AACV;AACA;EACE,OAAO;EACP,iBAAiB;EACjB,YAAY;EACZ,kBAAkB;EAClB,YAAY;EACZ,qBAAqB;EACrB,yBAAyB;EACzB,aAAa;AACf;AACA;EACE,mCAAmC;AACrC;;AAEA;EACE,OAAO;EACP,kBAAkB;EAClB,qBAAqB;EACrB,yBAAyB;EACzB,YAAY;AACd;;AAEA;EACE,6BAA6B;AAC/B;AACA;EACE,WAAW;EACX,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,YAAY;EACZ,6BAA6B;AAC/B;;AAEA;EACE,eAAe;EACf,kBAAkB;AACpB;AACA;EACE,OAAO;AACT;AACA;EACE,aAAa;AACf;;AAEA;EACE,OAAO;EACP,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB","sourcesContent":["* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n:root {\n  --main-color: rgb(189, 205, 221);\n  --option-color: rgb(120, 182, 245);\n}\nbody,\nhtml {\n  min-width: 100vw;\n  min-height: 100vh;\n  user-select: none;\n}\n\nbody {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  padding: 20px;\n  font-family: \"Gill Sans\", \"Gill Sans MT\", Calibri, \"Trebuchet MS\", sans-serif;\n  background: floralwhite;\n}\n\nheader {\n  position: relative;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.content {\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n  gap: 10px;\n}\n\n.cards {\n  display: flex;\n  flex-direction: column;\n  flex: 1 1 auto;\n  overflow-y: auto;\n  height: 0px;\n  border-radius: 5px;\n  gap: 5px;\n}\n\n#bar-days {\n  background: lightgray;\n  flex: 1;\n  border-radius: 5px;\n  display: flex;\n  gap: 5px;\n}\n\n#bar-days > .weather-day {\n  border-radius: 5px;\n  padding: 3px;\n  flex: 1;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background: lightgray;\n  color: white;\n}\n\n#bar-days > .weather-day:hover {\n  background: var(--main-color);\n  transition: all 0.5s ease;\n}\n\n#bar-days > .weather-day.selected-day {\n  background: var(--option-color);\n  transition: all 0.5s ease;\n}\n\n#card-content {\n  flex: 9;\n  background: lightgray;\n  border-radius: 5px;\n  display: flex;\n  flex-direction: column;\n}\n\n#bar-options {\n  flex: 1;\n  display: flex;\n}\n\n#general-opt,\n#detail-opt {\n  flex: 1;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background: var(--main-color);\n  transition: all 0.5s ease;\n  color: white;\n}\n\n#general-opt {\n  border-radius: 5px 0 0 0;\n}\n\n#detail-opt {\n  border-radius: 0 5px 0 0;\n}\n\n#general-opt.active,\n#detail-opt.active {\n  background: var(--option-color);\n}\n\n#option-content {\n  flex: 9;\n  display: flex;\n}\n\n.chart {\n  height: 200px;\n}\n\n.search-weather {\n  display: flex;\n  gap: 5px;\n}\n.search-weather input[type=\"text\"] {\n  flex: 8;\n  font-size: 1.3rem;\n  padding: 5px;\n  border-radius: 5px;\n  border: none;\n  background: lightgrey;\n  transition: all 0.5s ease;\n  outline: none;\n}\n.search-weather input[type=\"text\"]:hover {\n  background-color: var(--main-color);\n}\n\n.search-weather button {\n  flex: 1;\n  border-radius: 5px;\n  background: lightgrey;\n  transition: all 0.5s ease;\n  border: none;\n}\n\n.search-weather button:hover {\n  background: var(--main-color);\n}\n#progress-bar {\n  width: 100%;\n  position: absolute;\n  top: 0;\n  left: 0;\n  border: none;\n  background-color: transparent;\n}\n\n#waiting-icon {\n  font-size: 20vw;\n  text-align: center;\n}\ntable {\n  flex: 1;\n}\ntable tr {\n  display: flex;\n}\n\ntable tr th {\n  flex: 1;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n"],"sourceRoot":""}]);
// Exports
